...
x86.button-ipv6: button.x86
	./button.x86 ff12::1234

x86.light-ipv6: light.x86
	./light.x86 ff12::1234

x86.button-serial: button.x86
	./button.x86 /dev/ttyACM0

x86.light-serial: light.x86
	./light.x86 /dev/ttyACM0
