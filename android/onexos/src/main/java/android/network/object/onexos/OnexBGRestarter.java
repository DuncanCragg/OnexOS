...
public class OnexBGRestarter extends BroadcastReceiver {
    private static String LOGNAME="Onex OnexBGRestarter";
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        ComponentName componentName = new ComponentName(context, OnexBGJob.class);
